...
namespace MagicDocs\Laravel\Commands;
...
class Watch extends Command
{
    ...
    public function handle()
    {
        ...
        $config['watchJs'] ??= base_path('vendor/bradietilley/magicdocs/watch.js');
        $config['watchJson'] ??= base_path('vendor/bradietilley/magicdocs/watch.json');
