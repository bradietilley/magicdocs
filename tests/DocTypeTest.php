...
use MagicDocs\ReflectionParameterItem;
use MagicDocs\SomeEnum;
...
it('can form an argument list', function () {
    ...
    expect((string) $args)->toBe('string $basic, \Stringable&\JsonSerializable $nonUnion, int|null $nullable = null, \MagicDocs\SomeEnum $enum = \MagicDocs\SomeEnum::AA, string|int $union = "default"');
});
...
it('can form a variable string', function () {
    ...
    expect((string) VariableString::parse(SomeEnum::AA))->toBe('\MagicDocs\SomeEnum::AA');
